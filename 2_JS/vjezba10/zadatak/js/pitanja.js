const skupPitanja = [{
    ...
    {
        pitanje: 'Koja ulica ide paralelno s Divaltovom u Osijeku?',
        tocno: 'Vukovarska cesta',
        odgovori: ['Vukovarska ulica', 'Vukovarska cesta', 'Vukovarska avenija']
    }, 
    {
        pitanje: 'Koja grad ima najviše stanovnika od navedenih?',
        tocno: 'Tokyo',
        odgovori: ['New York', 'Istanbul', 'Tokyo']
    },
    {
        pitanje: 'Kada netko jede montecristo sendvič on zapravo jede što?',
        tocno:'tost s kajgonom',
        odgovori: ['Kajganu', 'pohani kruh', 'toast s kajganom']
    }
];